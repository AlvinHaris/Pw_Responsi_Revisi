...
const _imports_0$3 = "" + buildAssetsURL("thom yorke is such a rock star(1) png.CqfnwGdG.png");
const _sfc_main$4 = {
  name: "ContactSection",
  mounted() {
    setTimeout(() => {
...
const _imports_0$2 = "" + buildAssetsURL("ad 4.CSmwQdDA.jpg");
const _imports_1 = "" + buildAssetsURL("Bateman.BIX4Hs5W.jpg");
const _imports_2 = "" + buildAssetsURL("Lego White Stripes Iklan.CgcMUGdB.jpg");
const _imports_3 = "" + buildAssetsURL("Radiohead.DnpOrkwV.jpg");
const _sfc_main$3 = {
...
const _imports_0$1 = "" + buildAssetsURL("Control.BsXbxOZf.png");
const _sfc_main$2 = {
  name: "ImageSection",
  mounted() {
    setTimeout(() => {
...
const _imports_0 = "" + buildAssetsURL("Name.D3Un52bg.jpg");
const _sfc_main$1 = {
  name: "HeroSection"
};
...
//# sourceMappingURL=index-BGz58g5J.mjs.map
