    ...
    <div class="container">
      <div class="main-body">
        <div class="row gutters-sm">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                  <img src="/assets/Name.jpg" alt="Admin" class="rounded-circle" width="150">
                  <div class="mt-3">
                    <h4>Alvin Haris Suherdi</h4>
                    <p class="text-secondary mb-1">Graphic Design</p>
                    <p class="text-muted font-size-sm">Bantul, Jogja</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card mb-3">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary">
                    alvinsuherdi@students.amikom.ac.id
                  </div>
                </div>
                <hr>
                <div class="row">
          ...
          <div class="col-md-4 offset-md-4"> <!-- Menggunakan offset untuk memindahkan ke tengah -->
            <div class="card mt-3">
              <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  ...
                  <a href="https://radiohead.com/" class="link-black">Radiohead.com</a>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">
                  ...
                  <a href="https://github.com/AlvinHaris" class="link-black">LuckyFat</a>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">
                  ...
                  <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="link-black">LuckyFat</a>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">
                  ...
                  <a href="https://www.instagram.com/crwbr.alvin" class="link-black">Crwbr.alvin</a>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                  <h6 class="mb-0">
                  ...
                  <a href="https://www.facebook.com/share/JFVAjCYLLK5ouF9q/?mibextid=qi2Omg" class="link-black">Crowbar Alvin</a>
                </li>
              </ul>
            </div>
          </div>
